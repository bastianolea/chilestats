...
readr::write_rds(datos_cead, "delincuencia/datos/cead_delincuencia_crudo.rds", compress = "gz")
...
#guardar
# readr::write_csv2(cead, "delincuencia/datos/cead_incivilidades.csv")
arrow::write_parquet(cead, "delincuencia/datos/cead_delincuencia.parquet")
